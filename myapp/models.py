...
class Review(models.Model):
    ...
    rating = models.IntegerField()  # The rating (e.g. 1-5 stars).
...
class UserProfile(models.Model):
    ...
    bio = models.TextField(blank=True)  # A short bio about the user (optional).
    favorite_category = models.ForeignKey(Category, on_delete=models.SET_NULL, null=True, blank=True)  # The user's favorite category (optional).
